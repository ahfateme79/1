(function($) {
	...
	if($('.cs-countdown').length){
	   ...
	   $('.cs-countdown').countdown('').on('update.countdown', function(event) {
		  var $this = $(this).html(event.strftime('<div><span>%m</span><h6>Months</h6></div> <div><span>%D</span><h6>روز</h6></div> <div><span>%H</span><h6>ساعت</h6></div> <div><span>%M</span><h6>دقیقه</h6></div> <div><span>%S</span><h6>ثانیه</h6></div>'));
		});
	}
